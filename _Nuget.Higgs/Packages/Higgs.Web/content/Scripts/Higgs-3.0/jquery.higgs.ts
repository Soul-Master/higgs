...
module Higgs.Rules
{
    ...
    export interface PatternValidationData
    {
        pattern?: string;
    }
    ...
    export class PatternValidation extends Higgs.AbstructValidation
    {
        ...
        static create(el: HTMLInputElement, data: PatternValidationData): Higgs.AbstructValidation
        {
    ...
    export interface NumberValidationData extends PatternValidationData
    {
        decimal?: boolean;
        'integer'?: boolean;
    }
    ...
    export class NumberValidation extends PatternValidation
    {
        ...
        static create(el: HTMLInputElement, data: NumberValidationData): Higgs.AbstructValidation
        {
            var validation = null;
    ...
    export interface UrlValidationData extends PatternValidationData
    {
        url?: boolean
    }
    ...
    export class UrlValidation extends PatternValidation
    {
        ...
        static create(el: HTMLInputElement, data: UrlValidationData): Higgs.AbstructValidation
        {
            var validation = null;
    ...
    export interface EmailValidationData extends PatternValidationData
    {
        email?: boolean;
    }
    ...
    export class EmailValidation extends PatternValidation
    {
        ...
        static create(el: HTMLInputElement, data: EmailValidationData): Higgs.AbstructValidation
        {
            var validation = null;
