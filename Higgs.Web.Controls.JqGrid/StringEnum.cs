...
namespace Higgs.Web.Controls.JqGrid
{
    ...
    public class StringEnum
    {
        ...
        public Array GetStringValues()
        {
            ...
            foreach (var attrs in
                _enumType.GetFields().Select(fi => fi.GetCustomAttributes(typeof (StringValueAttribute), false) as StringValueAttribute[]).Where(attrs => attrs.Length > 0))
            {
